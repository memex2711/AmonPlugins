...
@app.on_message(filters.command(["mon"], prefixes=["a", "A"]))
...
__MODULE__ = "Gpt"
__HELP__ = """
<blockquote expandable>📋 <b>Gpt & Ai Commands</b>

• /gpt - Access GPT functionality.
• /bard - Invoke the Bard feature.
• /llama - Engage with LLaMA mode.
• /gemini - Invoke the Gemini feature.
• /geminivision - Explore Gemini mode.
• /mistral - Activate Mistral code.
• /enhance - Image upscale free API.
