...
__MODULE__ = "Sticker"
__HELP__ = """
<blockquote expandable>📋 <b>Sticker Commands</b>

• /mmf - Meme-ify the image or sticker.
• /tiny - Reply to a sticker to make it tiny.
• /kang - Kang images into stickers.
• /packkang - Create a pack from another sticker pack.
• /stid - Get the sticker ID of a sticker.
• /st - Provide the sticker ID to fetch the sticker.
• /meme - Generate memes.
• /stdl - Download the sticker.
