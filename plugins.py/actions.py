...
<b>/tmute</b> – temporary mute (e.g., /tmute @user 1h)
<b>/kick</b> – kick a user (auto‑unban after 2s)
<b>/dban</b> – delete message & ban (reply only)
<b>/sban</b> – silent ban (no notification)
<b>/kickme</b> – user self‑kick (auto‑unban after 3s)
<b>/tban</b> – temporary ban (e.g., /tban @user 1d)
...
from AmonMusic.utils.decorator import admin_required
from AmonMusic.utils.permissions import extract_user_and_reason, mention, parse_time
